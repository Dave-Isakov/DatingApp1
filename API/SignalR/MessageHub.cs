...
namespace API.SignalR
{
    public class MessageHub : Hub
    {
        ...
        public async Task SendMessage(CreateMessageDTO createMessageDTO)
        {
            ...
            if(recipient == null) throw new HubException("That recipient does not exist.");
            ...
            {
                var conenctions = await _tracker.GetConnectionsForUser(recipient.UserName);
                if(conenctions != null)
                {
                    await _presenceHub.Clients.Clients(conenctions).SendAsync("NewMessageReceived", new 
                    {
